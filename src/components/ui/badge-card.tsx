  ...
  'inline-flex items-center rounded-[10px] border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        success: 'border-green-100 text-green-10 bg-green-50',
        regress: 'border-red-50 text-red-600 bg-red-10 dark:bg-red-300 dark:text-black',
...
function BadgeCard({ className, variant, ...props }: BadgeProps) {
  return <div className={cn(badgeVariants({ variant }), className)} {...props} />;
}

export { BadgeCard, badgeVariants };
